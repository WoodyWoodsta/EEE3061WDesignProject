...
\newcommand{\hmwkTitle}{Robot Demo Report} % Assignment title
...
\vspace{2in}
\textmd{\textbf{\LARGE \hmwkClass\\ \Huge \hmwkTitle \\ \vspace{2in} \Large \hmwkAuthorName}}\\
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.75\columnwidth]{FinalRender-Leg}
    \label{liquidDiagram}
  \end{center}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1\columnwidth]{RobotPic}
    \label{liquidDiagram}
  \end{center}
\end{figure}
