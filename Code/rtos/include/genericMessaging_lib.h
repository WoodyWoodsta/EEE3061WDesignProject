...
typedef enum {
  ...
  MSG_CMD_LED_ON,
  MSG_CMD_LED_OFF,
  MSG_CMD_LED_BLINK_SLOW,
  MSG_CMD_LED_BLINK_FAST,
  MSG_CMD_LED_BLINK_SUPERFAST,
  MSG_CMD_BUZZER_ON,
  MSG_CMD_BUZZER_OFF,
  MSG_CMD_BUZZER_BURST_ONCE,
  MSG_CMD_BUZZER_BURST_TWICE,
  MSG_CMD_BUZZER_BURST_THRICE,
  MSG_CMD_BUZZER_PULSE_SLOW,
  MSG_CMD_BUZZER_PULSE_FAST
} msgCommand_t;
